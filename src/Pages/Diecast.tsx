...
const Diecast = () => {
  ...
  const diecast = DieCast.filter((item)=>item.category.includes('Hotwheels'))
    ...
    <div className=''>
      ...
      <div className="text-center mb-12 pt-8">
                    ...
                    <p className="text-sm text-gray-500 mt-3">
                        {diecast.length} Exclusive Models
                    </p>
                </div>
                        ...
                        >
                            ...
                            <div className="p-6 flex flex-col flex-1">
                                ...
                                <p className="mt-4 text-3xl font-semibold text-gray-900">
                                    Rs. {(typeof product.price === 'string' ? parseInt(product.price) : product.price).toLocaleString()}
                                </p>
                                ...
                                <div className="flex gap-3 mt-auto pt-6">
                                    ...
                                    onClick={() => addToCart({
                                      ...product,
                                      price: typeof product.price === 'string' ? parseInt(product.price, 10) : product.price,
                                    })}>
                                        Add to Cart
                                    </button>
